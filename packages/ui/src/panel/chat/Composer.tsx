...
import { AttachedChips, useMentionMenu } from './Mentions.tsx';
...
export function Composer({
  ...
  onSend: () => void;
  /** References and experiments going with the next message, in the order they were added. */
  ...
  return (
    <div className="composer">
      <AttachedChips attached={attached} onAttach={onAttach} />
      {mention.menu}
      <textarea
        ref={ref}
        value={value}
...
function NextRun({
  ...
  const anchor = useAnchoredAbove(trigger, open, 'right');
  useDismiss(
    open,
